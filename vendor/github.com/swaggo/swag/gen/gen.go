...
// Build builds swagger json file  for gived searchDir and mainApiFile.
func (g *Gen) BuildSwaggerJson(searchDir, mainApiFile, swaggerConfDir string,host string) error {
	log.Println("Generate swagger docs....")
	p := swag.New()
	p.ParseApiCustom(searchDir, mainApiFile,host)
	swagger := p.GetSwagger()
	...
	os.MkdirAll(swaggerConfDir, os.ModePerm)
